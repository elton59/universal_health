        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <center><button onclick="window.location.replace('createfeedback.php')" class="btn btn-info" >Compose A new message</button></center>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                    ...
                                    <th>Message</th>
                                        ...
                                        <?php
                                        $result=$mysqli->query("select * from feedback where email='$user' ") or die($mysqli->error);
                                        while($row=$result->fetch_assoc())
                                        {
                                            echo
                                            "
