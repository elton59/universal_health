                                ...
                                <div class="form-group">
                                    <label>Payment Mode</label>
                                        <select class="form-control" name="paymode">
                                            <option value="male">MPESA</option>
                                            <option value="female">CARD</option>
</select>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" name="paytid" placeholder="Transaction ID" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="datetime-local" name="paydate" placeholder="Input payment Date" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" name="payamnt" placeholder="Total Amount" required/>
                               </div>    
                               <div class="form-group">
                                        <input class="form-control" name="paypatid" placeholder="Patient ID" required/>
                               </div>                     
                               <div class="form-group">
                                        <input class="form-control" name="paysid" placeholder="Supplier ID" required/>
                               </div>
                               <div class="form-group">
