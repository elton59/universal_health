                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="supid" placeholder="Input supplier ID" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="date" name="supdtime" placeholder="Delivery Time" required/>
                               </div>
                               <div class="form-group">
