                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="apspec" placeholder="Input Specialization" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="text" name="aptype" placeholder="Appointment Type" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="text" name="appatid" placeholder="patientid" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="text" name="apstid" placeholder="staffid" required/>
                               </div>
                               <div class="form-group">
