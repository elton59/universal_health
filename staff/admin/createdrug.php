        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Create Drug</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Create Drug</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive"  >
                                <form method="POST" action="../process.php"> 
                                <div class="form-group">
                                        <input class="form-control" name="drtid" placeholder="Input treatmentid" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" name="drfuname" placeholder="fullname" required/>
                               </div>
                               <div class="form-group">
