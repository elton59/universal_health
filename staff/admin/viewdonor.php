...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">View Donor</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">View Donor</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <th>Password</th>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td>".$row['password']."</td>
                                           <td>".$row['status']."</td>
                                           <td> <a href='viewdonor.php?apsid=$row[id]' class='btn btn-success'>approve<a>
                                           <a href='viewdonor.php?rjsid=$row[id]' class='btn btn-danger'>Reject<a></td>
                                            </tbody>
                                            ";
                                        }
                                        ?>
  ...
  {
    $id=$_GET['apsid'];
    $result = $mysqli->query("UPDATE donor SET Status= 'approved' WHERE id = $id") or die($mysqli->error);
  ...
  {
    $id=$_GET['rjsid'];
    $result = $mysqli->query("UPDATE  SET Status= 'rejected' WHERE id = $id") or die($mysqli->error);
