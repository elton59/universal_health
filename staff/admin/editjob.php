                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                    ...
                                    <th>Description</th>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td>".$row['description']."</td>
                                            <td><a href='editjob.php?editjob=$row[id]' class='btn btn-primary'>Edit</a>
                                                 <a href='../process.php?reditjob=$row[id]' class='btn btn-danger'>Delete</a>
                                                 </td>
                                            </tbody>
                                            ";
                                        }
                                 ...
                                 {
                                     $id=$_GET['editjob'];
                                     $result=$mysqli->query("select * from jobs  where id='$id'")or die($mysqli->error);
                                     $row=$result->fetch_assoc();
                                     $jbtitle=$row['jobtitle'];
                                     $jbdes=$row['description'];
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="jbtitle" placeholder="Job Title" value=<?php echo $jbtitle?> required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="text" name="jbdes" placeholder="Description" value=<?php echo $jbdes ?> required/>
                               </div>
                                                        
                               <div class="form-group">
                                   <input class="from control btn btn-primary" type="submit" value="submit" name="editjob"/>
