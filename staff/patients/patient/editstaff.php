                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                 ...
                                 <?php
                                     ...
                                     $result=$mysqli->query("select * from users  where email='$login_session'")or die($mysqli->error);
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="staffspec" placeholder="Input Specialization"  value="<?php echo $staffspec ?>"required readonly/>
                               </div>
                               <div class="form-group">
                             ...
                             <label>Phone Number</label>
                              ...
                              <label>Email</label>
                               ...
                               <div class="form-group">
                                   <input class="from control btn btn-primary" type="submit" value="Update Profile" name="editstaff"/>
