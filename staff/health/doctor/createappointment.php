                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="apspec" placeholder="reason for appointment" required/>
                               </div>
                               <div class="form-group">
                               ...
                               <div class="form-group">
                                   <label>Select Patient</label>
                                         <select name="appatid" class="form-control">
                                      
                                      <?php 
                                       $result=$mysqli->query("select * from users where specialization='patient' and status='approved'")or die($mysqli->error);
                                       $drivers_list=array();
                               ...
                               <div class="form-group">
                                        <input class="form-control" type="text" name="apstid" placeholder="staffid" value="<?php echo $login_session ?>" required readonly/>
                               </div>
                               <div class="form-group">
