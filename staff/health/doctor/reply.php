    ...
    <div class="card-body">
        <div class="table-responsive"  >
           ...
           <div class="form-group">
                    <input name="fdreceiver" value="<?php echo $fem?>"  readonly class="form-control"/>
           </div>
       <label>Message</label>
           <div class="form-group">
           <input  value="<?php echo $fm?>" class="form-control" readonly/>
           </div>
           <label>Response</label>
           <div class="form-group">
                    <textarea  class="form-control" type="text" name="fdmessage" placeholder=" Response" required></textarea>
           </div>
