                        ...
                        <div class="card-body">
                            ...
                            <th>Appointmenttype</th>
                                    ...
                                    <th>Status</th>
                                        ...
                                        $result=$mysqli->query("SELECT appointments.*,users.firstname as firstname,users.lastname as Lastname,users.firstname as pfirstname,users.lastname as plastname,users.id as patid
                                        FROM appointments  JOIN doctors ON doctors_email =doctors.email JOIN users ON patient_email =users.email where appointments.status='approved'and appointments .doctors_email='$login_session' order by id desc    ") or die($mysqli->error);
