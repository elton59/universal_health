        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <?php 
                                       $result=$mysqli->query("select * from users where specialization='pharmacist' and status='approved'")or die($mysqli->error);
                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                ...
                                <div class="form-group">
                                        <input class="form-control" type="text" name="trsid" placeholder="Doctor ID" value='<?php echo "$apapsid"?>' readonly required/>
                               </div>
                               <div class="form-group">
                                   <label>Select Pharmacist</label>
                                         <input  name="trpham" class="form-control" value="<?php echo $driver_email?>" readonly>
                                      
                                   
                        
                               </div>
                                <div class="form-group">
                                        <input class="form-control" name="trtr" placeholder="Recommendation" required/>
                               </div>
                             
                                                         
                               <div class="form-group">
                                   <input class="from control btn btn-primary" type="submit" value="submit" name="createlabtreatment"/>
